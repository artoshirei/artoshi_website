...
export const TextOverlay = () => {
  ...
  /* Pretext: prepareWithSegments when font changes; layoutNextLine when widths update (study-007). */
  useEffect(() => {
    ...
    const fontStr = `${fontSize}px "Instrument Sans", "Helvetica Neue", sans-serif`;
  ...
  return (
    <div ref={overlayRef} className="pointer-events-none absolute inset-0">
      {lines.map(({ text, rowIdx, widthPx }) => {
        ...
        const topPx = viewportHeight / 2 - y - lineHeightPx / 2;
